...
public class Main extends javax.swing.JFrame {
   ...
   int function=1; // sigmoid
    ...
    private void initComponents() {
        ...
        color_to_test = new javax.swing.JComboBox<>();
        jButton5 = new javax.swing.JButton();
        jLabel7 = new javax.swing.JLabel();
        sweetness_to_test = new javax.swing.JTextField();
        ...
        SweetnessjLabel1.setBounds(70, 180, 100, 25);
        ...
        colorlabel3.setBackground(new java.awt.Color(255, 204, 204));
        colorlabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        colorlabel3.setForeground(new java.awt.Color(255, 255, 255));
        colorlabel3.setText("Color :");
        jPanel2.add(colorlabel3);
        colorlabel3.setBounds(330, 270, 60, 20);
        ...
        color_to_test.setBackground(new java.awt.Color(255, 204, 255));
        color_to_test.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        color_to_test.setForeground(new java.awt.Color(255, 255, 255));
        color_to_test.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Red", "Orange", "Yellow" }));
        jPanel2.add(color_to_test);
        color_to_test.setBounds(390, 270, 90, 20);
        ...
        jButton5.setBounds(260, 340, 130, 27);
        ...
        sweetness_to_test.setBackground(new java.awt.Color(255, 204, 204));
        sweetness_to_test.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        sweetness_to_test.setForeground(new java.awt.Color(102, 102, 255));
        sweetness_to_test.setToolTipText("");
        sweetness_to_test.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sweetness_to_testActionPerformed(evt);
            }
        });
        jPanel2.add(sweetness_to_test);
        sweetness_to_test.setBounds(420, 300, 60, 30);

        jButton6.setBackground(new java.awt.Color(255, 204, 255));
        jButton6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton6.setForeground(new java.awt.Color(102, 0, 51));
        jButton6.setText("ADD FRUIT");
        ...
        jButton6.setBounds(250, 220, 150, 27);
        ...
        colorlabel5.setBackground(new java.awt.Color(255, 204, 204));
        colorlabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        colorlabel5.setForeground(new java.awt.Color(255, 255, 255));
        colorlabel5.setText("Data To Test: ");
        jPanel2.add(colorlabel5);
        colorlabel5.setBounds(70, 270, 120, 25);

        colorlabel6.setBackground(new java.awt.Color(255, 204, 204));
        colorlabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        colorlabel6.setForeground(new java.awt.Color(255, 255, 255));
        colorlabel6.setText("Sweetness :");
        jPanel2.add(colorlabel6);
        colorlabel6.setBounds(330, 300, 120, 20);
 ...
 hiddenSize=Integer.parseInt(neurons_txt.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (color_to_test.getSelectedItem()=="Apple")
             color_test=0;  
        else if (color_to_test.getSelectedItem()=="Orange")
             color_test=1;  
        else if (color_to_test.getSelectedItem()=="Bananah")
             color_test=2;  
        ...
        test_element[1] = sweetness_test;
         ...
         if (predictedClass==0) 
             path="C:\\Users\\lolog\\Documents\\NetBeansProjects\\Fruit_Recognition_proj\\src\\main\\java\\apple.jpg";
          else if (predictedClass==1)
                 path="C:\\Users\\lolog\\Documents\\NetBeansProjects\\Fruit_Recognition_proj\\src\\main\\java\\orange.jpg";
                  else if (predictedClass==2) 
                     path="C:\\Users\\lolog\\Documents\\NetBeansProjects\\Fruit_Recognition_proj\\src\\main\\java\\bananah.jpg";
    ...
    private void sweetness_to_testActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sweetness_to_testActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sweetness_to_testActionPerformed
...
JOptionPane.showMessageDialog(null,"Added:"+output.toString());
    ...
    private javax.swing.JComboBox<String> color_to_test;
    ...
    private javax.swing.JTextField sweetness_to_test;
